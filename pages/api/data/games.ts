...
export let games: IGame[] = [
    ...
    },
    {
        data: {
            ...
            genre: ['Action'],
            game_name: "Sifu",
            short_description: "Sifu — это история о юном бойце кунг-фу, который мстит за убийство своей семьи. У него нет союзников — только враги. Один против всех, он бережет память предков и в сражениях полагается только на свое уникальное боевое мастерство и таинственный медальон.",
            header_image: "https://image.api.playstation.com/vulcan/img/rnd/202201/1616/THJbARAq2YiRVUv5abCQ8GYQ.png?w=440&thumb=false",
            website: "http://www.teamfortress.com/",
        }
    },
    {
        data: {
            ...
            short_description: "Battlefield™ 2042 — это шутер от первого лица, в котором серия возвращается к легендарным масштабным сражениям. В недалёком будущем мир охватил хаос. Адаптируйтесь и преодолевайте трудности на постоянно меняющихся полях боя при поддержке своего отряда и с помощью передовых технологий вооружения.",
            header_image: "https://image.api.playstation.com/vulcan/img/rnd/202111/0818/wgpQjT76y2QtCHtDdFHPdrgu.png?w=440&thumb=false",
            website: "http://www.teamfortress.com/",
        }
    },
    {
        data: {
            ...
            short_description: "После крушения пассажирского самолета выжили только вы. Вокруг вас таинственный лес, полный смертельно опасных каннибалов.\n" + "Живой мир, в котором можно срубить каждое дерево и сорвать каждое растение. А под землей находится целая сеть пещер и озер.",
            header_image: "https://image.api.playstation.com/cdn/EP0238/CUSA12398_00/QABZIx8Ubf69EcsYvaiC1Zx0PPON7XvG.png?w=440&thumb=false",
            website: "http://www.teamfortress.com/",
        }
    },
    {
        data: {
            ...
            price:  210.00,
            genre: ['Action'],
            game_name: "STAR WARS™: Squadrons",
            short_description: "Освойте искусство сражений на звёздных истребителях в реалистичном симуляторе полёта STAR WARS™: Squadrons. Пристегните ремень и ощутите прилив адреналина в крови, участвуя в многопользовательских воздушных схватках от первого лица со своей эскадрильей.",
            header_image: "https://image.api.playstation.com/vulcan/img/rnd/202009/2410/aaIGMZl7LGnfbmQNOrHOrL6c.png?w=440&thumb=false",
            website: "http://www.teamfortress.com/",
        }
    },
    {
        data: {
            ...
            short_description: "Вернитесь в мир очаровательных ужасов Little Nightmares II — приключенческой игры с нагнетанием саспенса. Вы играете за мальчика Моно, попавшего в мир, деформированный Передачей от далекой башни.",
            header_image: "https://image.api.playstation.com/vulcan/ap/rnd/202010/0108/uxdypYdPjRXXKfSc1CxiLClp.png?w=440&thumb=false",
            website: "http://www.teamfortress.com/",
        }
    },
];
